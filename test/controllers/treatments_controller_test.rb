...
class TreatmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create treatment" do
    assert_difference('Treatment.count') do
      post treatments_url, params: { treatment: { category_id: @treatment.category_id, name: @treatment.name } }
    end
  ...
  test "should update treatment" do
    patch treatment_url(@treatment), params: { treatment: { category_id: @treatment.category_id, name: @treatment.name } }
